...
WebUI.setText(findTestObject('Object Repository/Register Page/Page_Register/input_Login_email'), 'dwitest5@gmail.com')
...
WebUI.click(findTestObject('Object Repository/Register Page/Page_Register/button_Next Step   please wait'))

WebUI.click(findTestObject('Object Repository/Register Page/Page_Register/div_Get paid easily from anywhere.         _163be7'))
